    ...
    tl = {
        ...
        setup(e) {
            const t = oi([{
                ...
                name: "邮箱：lzk110323@qq.com",
                text: "lzk110323@qq.com",
                status: "落青Cya"
            }, {
                name: "个人网站",
                url: "https://lzk0831.github.io/mysite1/",
                status: "落青Cya"
            }, {
                name: "特长：Web前端，图形化程序，IT运营，互联网资源查找",
                text: "Web前端，图形化程序，IT运营",
                status: "落青Cya"
            }, {
                name: "职务：落青Cya工作室Boss",
                text: "落青Cya工作室Boss",
                status: "落青Cya"
            }, {
                name: "落青工作室招人，无盈利，只要是志同道合的朋友都可以加入",
                text: "只要是志同道合的朋友都可以加入，工作室无盈利",
                status: "落青Cya"
            }, {
                name: "QQ：2071207340",
            ...
            function n(s = "") {
                if (s) location.href = s;
                    ...
                    const r = t.value.find((i) => i.status !== "落青工作室");
                    r ? (location.href = r.url) : alert("落青工作室")
                }
            }
